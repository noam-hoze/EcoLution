...
const EPOCH_ENTITIES: Record<Epoch, Entity[]> = {
  ...
  Corporate: [
    { id: 'msft', name: 'Microsoft', leader: 'Satya Nadella', value: 420.55, oxygen: 100, power: 80, control: 90, lineage: [], description: 'The OS Layer', isUser: false, status: 'Alive', position: { x: 55, y: 15 }, type: 'Incorporated', domains: ['Generative AI', 'Cloud Infrastructure'], logoUrl: 'https://www.google.com/s2/favicons?domain=microsoft.com&sz=128' },
    { id: 'goog', name: 'Google', leader: 'Sundar Pichai', value: 150.22, oxygen: 100, power: 85, control: 85, lineage: [], description: 'The Knowledge Layer', isUser: false, status: 'Alive', position: { x: 20, y: 15 }, type: 'Incorporated', domains: ['Generative AI', 'Cloud Infrastructure', 'Social Media'], logoUrl: 'https://www.google.com/s2/favicons?domain=google.com&sz=128' },
    { id: 'meta', name: 'Meta', leader: 'Mark Zuckerberg', value: 510.12, oxygen: 100, power: 75, control: 70, lineage: [], description: 'The Social Layer', isUser: false, status: 'Alive', position: { x: 20, y: 85 }, type: 'Incorporated', domains: ['Generative AI', 'Social Media'], logoUrl: 'https://www.google.com/s2/favicons?domain=meta.com&sz=128' },
    { id: 'aapl', name: 'Apple', leader: 'Tim Cook', value: 185.90, oxygen: 100, power: 90, control: 95, lineage: [], description: 'The Hardware Layer', isUser: false, status: 'Alive', position: { x: 70, y: 85 }, type: 'Incorporated', domains: ['Consumer Electronics'], logoUrl: 'https://www.google.com/s2/favicons?domain=apple.com&sz=128' },
    { id: 'anth', name: 'Anthropic', leader: 'Dario Amodei', value: 85.00, oxygen: 100, power: 40, control: 50, lineage: ['goog'], description: 'The Safety Layer', isUser: false, status: 'Alive', position: { x: 15, y: 25 }, type: 'Incorporated', domains: ['Generative AI'], logoUrl: 'https://www.google.com/s2/favicons?domain=anthropic.com&sz=128' },
    { id: 'nvda', name: 'NVIDIA', leader: 'Jensen Huang', value: 900.00, oxygen: 100, power: 95, control: 90, lineage: [], description: 'The Compute Layer', isUser: false, status: 'Alive', position: { x: 20, y: 55 }, type: 'Incorporated', domains: ['Semiconductors', 'Generative AI'], logoUrl: 'https://www.google.com/s2/favicons?domain=nvidia.com&sz=128' },
    { id: 'intl', name: 'Intel', leader: 'Pat Gelsinger', value: 45.00, oxygen: 100, power: 60, control: 50, lineage: [], description: 'The Legacy Layer', isUser: false, status: 'Alive', position: { x: 10, y: 55 }, type: 'Incorporated', domains: ['Semiconductors'], logoUrl: 'https://www.google.com/s2/favicons?domain=intel.com&sz=128' },
    { id: 'pltr', name: 'Palantir', leader: 'Alex Karp', value: 35.00, oxygen: 100, power: 50, control: 60, lineage: [], description: 'The Defense Layer', isUser: false, status: 'Alive', position: { x: 60, y: 50 }, type: 'Incorporated', domains: ['Defense & Aerospace', 'Generative AI'], logoUrl: 'https://www.google.com/s2/favicons?domain=palantir.com&sz=128' },
    { id: 'spcx', name: 'SpaceX', leader: 'Elon Musk', value: 180.00, oxygen: 100, power: 85, control: 80, lineage: [], description: 'The Frontier Layer', isUser: false, status: 'Alive', position: { x: 80, y: 50 }, type: 'Incorporated', domains: ['Defense & Aerospace'], logoUrl: 'https://www.google.com/s2/favicons?domain=spacex.com&sz=128' },
  ],
  AI: [
